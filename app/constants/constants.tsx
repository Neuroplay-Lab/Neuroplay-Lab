...
export const startingFeatures = [
    "Discovering the fascinating connection between synchrony, social cognition, and pro-group behavior.",
    "Exploring the innovative approaches to enhancing wellbeing in the autistic community through strengths-based methods and special interests.",
    "Potential of games—both analog and digital—as tools for social and cognitive enhancement, unlocking new avenues for personal development and enrichment.",
];

export const aboutGray = [
    {
        title: "Background",
        subtitle:
...
export const aboutLiam = [
    ...
    },
    {
        title: "Research Interests",
        subtitle:
            "My research interests encompass a diverse range of topics within psychology. I am particularly intrigued by the effects of Coordinated Rhythmic Movement on interpersonal relations and group dynamics, exploring how activities such as dancing, singing, or walking in synchrony influence affiliation, cooperation, and conformity among participants, ultimately shaping social identity. Additionally, I delve into nonverbal cues to deception and investigate the impact of specific statistical co-occurrences of language in media on attitudes towards immigration. Furthermore, I examine the effects of sexualized and violent video games on stereotypes and prejudice, and I explore whether theory of mind deficits in individuals with Autism Spectrum Disorder can be mitigated by altering stimuli from human to cartoon and animal representations.",
    },
];

import xSvg from "../../public/x-social-media-white-icon.svg";
import instagramSvg from "../../public/instagram-white-icon.svg";
import linkedInSvg from "../../public/linkedin-app-white-icon.svg";
import facebookSvg from "../../public/facebook-app-round-white-icon.svg";
